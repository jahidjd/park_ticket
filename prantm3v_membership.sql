...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2022 at 08:10 PM
...
--
-- Table structure for table `ride_category`
--

CREATE TABLE `ride_category` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `children_price` decimal(10,2) DEFAULT NULL,
...
--
-- Dumping data for table `ride_category`
--

INSERT INTO `ride_category` (`id`, `name`, `children_price`, `adult_price`, `vat`, `status`) VALUES
(1, 'Water ride', '100.00', '150.00', 15, 'inactive'),
(3, 'Bumper boats', '150.00', '250.00', 15, 'active');
...
INSERT INTO `tickets` (`id`, `category_id`, `rider_name`, `phone`, `price`, `adult_qty`, `child_qty`, `vat`, `discount`, `date`, `created_by`) VALUES
(9, 1, 'Jahid Hasan', '01627809808', '295.00', 2, NULL, '45.00', '50.00', '0000-00-00', 7),
(10, 1, 'Naim', '01627809808', '237.50', 1, 1, '37.50', '50.00', '0000-00-00', 7),
(11, 1, 'Naim', '01627809808', '237.50', 1, 1, '37.50', '50.00', '0000-00-00', 7),
(12, 1, 'Naim', '01627809808', '237.50', 1, 1, '37.50', '50.00', '0000-00-00', 7),
(13, 1, 'Naim', '01627809808', '237.50', 1, 1, '37.50', '50.00', '0000-00-00', 7);
...
--
-- Indexes for table `ride_category`
--
...
--
-- AUTO_INCREMENT for table `ride_category`
--
ALTER TABLE `ride_category`
